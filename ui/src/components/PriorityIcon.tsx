...
const priorityConfig: Record<string, { icon: typeof ArrowUp; color: string; label: string }> = {
  ...
  medium: { icon: Minus, color: priorityColor.medium ?? priorityColorDefault, label: "Media" },
  low: { icon: ArrowDown, color: priorityColor.low ?? priorityColorDefault, label: "Baja" },
};
